...
# Description: Adds a security warning when opening Nautilus as administrator
...
echo "📁 Installing warning script..."
...
# Disable original nautilus-admin extension if exists
...
echo "   2. Right-click on any folder, file, or empty space"
echo "   3. Select: 'Open as Administrator (with warning)'"
echo "   4. Read the warning and choose: ACCEPT or CANCEL"
echo ""
echo "🎨 Features:"
echo "   • Warning window with colors and icons"
echo "   • Clear message about administrator mode risks"
echo "   • ACCEPT / CANCEL buttons"
echo "   • Works on folders, files, and empty space"
echo ""
echo "⚠️  WARNING: Use this tool with caution."
echo "   Modifying system files can damage your Linux installation."
echo ""
